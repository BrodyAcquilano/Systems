...
const tocData = [
  ...
  },
  {
    ...
    description: 'How to model, measure, and reform system structures and write policies using ecological and engineering principles with economic considerations.',
    chapters: [
      {
  ...
  return (
    <aside className="left-sidebar">
      <div
        ...
        onClick={() => handleFileSelect("0. Table of Contents.md")}
      >
        Table of Contents
      </div>
      <ul>
        {tocData.map((part, partIndex) => (
          <li key={partIndex}>
            <div className="part-header" onClick={() => togglePart(partIndex)}>
                    ...
                    <div key={chapterKey}>
                      ...
                      {expandedChapters[chapterKey] && (
                        <ul className="section-list">
                          {chapter.sections.map((sectionTitle, sectionIndex) => (
                            <li
